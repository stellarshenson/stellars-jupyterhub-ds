 ...
 * localStorage under "duoptimum-hub-theme" - mirrors the static mock's app.js.
...
const STORAGE_KEY = 'duoptimum-hub-theme'
...
function readMode(): ThemeMode {
  try {
    ...
    if (m === 'duoptimum-hub-light') return 'light'
    if (m === 'duoptimum-hub-dark') return 'dark'
  } catch {
    /* ignore */
  }
  return 'system'
