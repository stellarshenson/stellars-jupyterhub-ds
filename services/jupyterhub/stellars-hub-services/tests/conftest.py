"""Shared fixtures for stellars_hub_services functional tests."""
...
from stellars_hub_services.activity.model import ActivityBase
...
def clean_password_cache():
    ...
    from stellars_hub_services.password_cache import _password_cache
