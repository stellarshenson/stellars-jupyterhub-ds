...
def orm_session(tmp_path, monkeypatch):
    ...
    from duoptimum_hub_services.event_log import EventLogManager
    from duoptimum_hub_services.user_profiles import UserProfileManager
...
def test_rename_event_names_the_actor(orm_session):
    ...
    from jupyterhub import orm as jh_orm
    from duoptimum_hub_services.events import set_rename_actor, reset_rename_actor
    from duoptimum_hub_services.event_log import EventLogManager
