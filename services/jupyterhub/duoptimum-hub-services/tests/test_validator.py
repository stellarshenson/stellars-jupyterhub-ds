...
from duoptimum_hub_services.policy import POLICY_TYPES
from duoptimum_hub_services.policy import validate_all as _validate_all
...
class TestInferActiveFlags:
    ...
    def _merged(self, stored):
        from duoptimum_hub_services.groups_config import default_config, infer_active_flags
