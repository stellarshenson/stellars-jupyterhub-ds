...
def _valid_values(**overrides):
    ...
    values = {
        ...
        "network_role_label_key": "hub.network.role",
        ...
        "hub_container_role_label": "hub",
        "lab_container_role_label": "lab",
        ...
        "docker_proxy_owner_label_key": "hub.docker.proxy.owner",
...
class TestRequiredErrors:
    @pytest.mark.parametrize(
        ...
        [
            ...
            "hub_container_role_label",
            "lab_container_role_label",
