...
def test_hydration_entry_importable():
    from duoptimum_hub_services import schedule_startup_hydration, start_activity_refreshers
...
def test_start_activity_refreshers_gates_gpu(monkeypatch):
    from duoptimum_hub_services import start_activity_refreshers
    from duoptimum_hub_services import volume_cache, container_size_cache, gpu_cache
