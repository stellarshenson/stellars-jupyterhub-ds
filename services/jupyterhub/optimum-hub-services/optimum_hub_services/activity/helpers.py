...
def get_activity_target_hours():
    """Daily active-hours target that scores 100% - the denominator the UI needs
    to show the uncapped activity % (which may legitimately exceed 100%)."""
    return ActivityMonitor.get_instance().target_hours
