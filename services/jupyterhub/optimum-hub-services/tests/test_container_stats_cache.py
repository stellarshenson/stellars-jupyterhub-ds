...
from optimum_hub_services import container_stats_cache as csc
from optimum_hub_services.docker_utils import stats_from_container
...
def fake_executor(monkeypatch):
    ...
    import optimum_hub_services.docker_utils as du
