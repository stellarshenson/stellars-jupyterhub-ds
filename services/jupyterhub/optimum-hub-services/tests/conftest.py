"""Shared fixtures for optimum_hub_services functional tests."""
...
from optimum_hub_services.activity.model import ActivityBase
...
def clean_password_cache():
    ...
    from optimum_hub_services.password_cache import _password_cache
