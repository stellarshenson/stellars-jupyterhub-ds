...
- [services/jupyterhub/optimum-hub-services/optimum_hub_services/docker_proxy.py](https://github.com/stellarshenson/stellars-jupyterhub-ds/blob/main/services/jupyterhub/optimum-hub-services/optimum_hub_services/docker_proxy.py) - hub-side wiring (`register_user`, `unregister_user`)
