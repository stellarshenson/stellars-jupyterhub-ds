...
jupyterhub_config.py          (data + orchestration)
  |
  +-- optimum_hub_services/           (pure logic)
...
```bash
cd services/jupyterhub/optimum_hub_services
