...
jupyterhub_config.py          (data + orchestration)
  |
  +-- duoptimum_hub_services/           (pure logic)
...
```bash
cd services/jupyterhub/duoptimum_hub_services
